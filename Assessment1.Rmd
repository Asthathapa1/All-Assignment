...
##This visualization helps to understand the total fat consumption per each restaurant. I think this type of visualization is best as it helps us tol
```
...
```{r}
##Step18
##The variable which should be factor and transforming thier type into factor variable
str(fastfood)
...
count(restaurant,calories_type, sort=TRUE)%>%ggplot(aes(calories_type,n,colour=calories_type))+
  ...
  geom_col() +
  geom_text(aes(label = round(n, digits = 2)),vjust =-0.2, color="black") +
  labs(x=" ", y=" " , title="Caloroes level in food items per restaurant" , caption = "Data visualization-Point")
```
